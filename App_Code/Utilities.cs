...
public static class Utilities
{
    ...
    public static void SendPassword(string recepientEmail, string subject, string body)
    {
        ...
        mailMessage.From = new MailAddress(ConfigurationManager.AppSettings["CustomerServiceEmail"], "JimEdwardsBits.com");
    ...
    public static void SendCustomerMessage(string recepientEmail, string subject, string body)
    {
        ...
        mailMessage1.From = new MailAddress(ConfigurationManager.AppSettings["CustomerServiceEmail"], "JimEdwardsBits.com");

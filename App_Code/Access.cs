...
public class Access
{
    ...
    public static string GetCartID(string CartID)
    {
        ...
        {
            CartID = HttpContext.Current.Request.Cookies["JIM_E_CartID"].Value;
        }
        else
        {
            Guid g;
            ...
            g = Guid.NewGuid();
            CartID = g.ToString();
            HttpCookie A_CartID = new HttpCookie("JIM_E_CartID");
    ...
    public static string LogIn(string Email, string Password)
    {
        ...
        if (get.Rows.Count > 0)
        {
            HttpCookie A_CustomerEmail = new HttpCookie("JIM_B_CustomerEmail");
            ...
            HttpCookie A_CustomerID = new HttpCookie("JIM_B_CustomerID");
            A_CustomerID.Value = get.Rows[0]["ID"].ToString();
    ...
    public static DataTable _U_Customer_Address(string Name, string Address, string State, string City, string Zip, string Type, string CustomerID)
    {
        // get a configured DbCommand object
        DbCommand comm = GenericDataAccess.CreateCommand();
        // set the stored procedure name

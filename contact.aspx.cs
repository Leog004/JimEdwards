...
public partial class contact : System.Web.UI.Page
{
    ...
    public static bool recieveUserEmail(string name, string email, string phone, string subject, string message)
    {
        ...
        Utilities.SendCustomerMessage(ConfigurationManager.AppSettings["CustomerMessages"], "Jim Edwards Bits Web Message", body);
    ...
    {
        //return String.Format("Name: {0}, Email: {1}, Phone: {2}, Subject: {3}, Message: {4}", name, email, phone, subject, message);
